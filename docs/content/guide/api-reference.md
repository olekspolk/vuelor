...
| Props       | Description |
| ----------- | ----------- |
| modelValue  | `null`, `string` or `ColorObject`                              |
| format      | `hex`, `hexa`, `hsl`, `hsla`, `hsv`, `hsva` or `object`        |
| ui          | `{ shared: { thumb: string }, slider: { root: string, track: string } }, input: { group: string, item: string, label: string, field: string }` |
